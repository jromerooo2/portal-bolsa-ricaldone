                                        ...
                                        <Link  href={'/advanced/profiles/'+profile.idPostulant} >
                                            <div  className="p-2 my-6 cursor-pointer md:my-9 card md:w-auto w-46">
                                                <div className={`bg-white rounded-lg shadow-xl p-4 ${profile.Alumni ? "border border-yellow-500":""}`}>
                                                    <div className="flex items-center justify-center">
                                                        <img src={`data:image/jpeg;base64,${profile.photoPostulant}`} alt={profile.namePostulant} className="mx-auto rounded md:h-40" />
                                                     </div>
                                                    <div className="space-y-5">
                                                        <h1 className="text-xl font-bold text-lime-900">{profile.namePostulant} <br></br> {profile.lastName}</h1>
                                                    </div>
                                                </div>
                                            </div>
                                        </Link>
